...
### **Public** replacement rate (since 2021) {.value-box}
...
valueBox("31%", 
         ...
         caption = "Public replacement rate (since 2021)")
```

### **Public** pipes replaced (since 2021) {.value-box}

```{r}
valueBox("1067 pipes", 
         icon = "ion-merge", color = pal[4],
         caption = "Public replacement count (since 2021)")
```


### **Private** replacement rate (since 2021) {.value-box}

```{r}
valueBox("17%", 
         icon = "ion-ios-home", color = pal[5],
         caption = "Private replacement rate (since 2021)")
```

### **Private** pipes replaced (since 2021) {.value-box}

```{r}
valueBox("584 pipes", 
         icon = "ion-ios-home", color = pal[5],
         caption = "Private replacement count (since 2021)")
```

Row
-------------------------------------

### **Lead pipes replaced over time**, last updated `r paste(Sys.time())`
...
p <- ggplot(rates, aes(time, count, color = type)) +
  ...
  labs(x = "", y = "Pipes replaced", color = "Type")
plotly::ggplotly(p)
```
